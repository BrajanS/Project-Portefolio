...
export default function AdminExperiencePro() {
  ...
  async function handleDel(id) {
    ...
    if (response.ok) {
      ...
      //   console.log(data);
      enqueueSnackbar(
        `L'expérience professionel "${data.value}" vien d'être supprimée.`,
        {
          variant: "error",
  ...
  function changingExpProVal1(e) {
    setExpProVal1(e.target.value);
  }
  function changingExpProVal2(e) {
    setExpProVal2(e.target.value);
  }
  function changingExpProVal3(e) {
    setExpProVal3(e.target.value);
  }
  function changingExpProVal4(e) {
    setExpProVal4(e.target.value);
  }
  ...
  async function handleSave() {
    if (
      ...
      if (saveData.ok) {
        ...
        // console.log(data);
        enqueueSnackbar(
          `L'expérience professionnel "${data.value}" à été ajouter.`,
          {
            variant: "success",
            autoHideDuration: 1200,
          }
          ...
          <div className="flex flex-col gap-1">
            <div className="flex w-[350px] gap-1">
              <input
                ...
                type="text"
                placeholder="Années"
                onChange={(e) => changingExpProVal1(e)}
              />
              <input
                value={expProVal2}
                ...
                onChange={(e) => changingExpProVal2(e)}
              />
            </div>
            <input
              value={expProVal3}
              ...
              type="text"
              placeholder="Poste"
              onChange={(e) => changingExpProVal3(e)}
            />
            <input
              value={expProVal4}
              className="bg-[#cccccc] rounded-[5px] px-[5px]"
              ...
              type="text"
              placeholder="Mission"
              onChange={(e) => changingExpProVal4(e)}
            />
          </div>
